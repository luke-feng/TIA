...
from LP_Supervised import LP_Supervised_Algo


'''This script is used to do the topo inference through supervised learning method.'''
...
def main():
    ...
    ATTACK_MODEL = ["logistic", "random_forest", "svm"]
                                ...
                                for metric in METRIC:
                                    ...
                                    for algo in AlGO:
                                        ...
                                        for model in ATTACK_MODEL:
                                            case_dict["Model"] = model
                                            
                                            for rou in ROUND:
                                            
                                                topo_algo = LP_Supervised_Algo(case_dict=case_dict, graph_object=G, 
                                                                    excel_path=f"./saved_results/{metric}/Extra_cases_{num}/{file_name}",
                                                                    attack_path=f"./saved_results/Attack_Performance/Extra_cases_{num}/Link_Prediction_Supervised_{iid}_{rou-1}.xlsx",
                                                                    round_case=rou)
