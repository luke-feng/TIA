...
def extract_filtered_column_values(file_name, column_name, filters):
    ...
    # Check if the specified column exists in the filtered DataFrame
...
def plot_topology_bars_advanced(x1, x2, y, save_dir, file_name):
    topologies = x1
    models = x2  # Fake model names

    f1_scores = y
    
    # X axis setup: bar positions for each topology and model group
...
def main():
    ...
    ALGO = [ "Algo_multi", "Algo_column", "Algo_row", "Algo_average"]
                                ...
                                for dataset in DATASET:
                                    ...
                                    for topo in TOPOLOGY:
                                        ...
                                        for clustering in ClUSTERING:
                                            file_path = f"./saved_results/Attack_Performance/Extra_cases_{num}/Link_Prediction_Clustering_{iid}_{rou}.xlsx"
                                            
                                            column_to_extract = "F1"
                                    ...
                                    plot_topology_bars_advanced(TOPOLOGY, ClUSTERING, f1_scores, f"./saved_results/Attack_Plots/Extra_cases_{num}/{metric}/Cluster/{algo}",                                                                             plot_name)
